...
run Hawaiian_Indices_Updated.m;
run South_Pacific_Indices_Updated.m;
run South_Atlantic_Indices_Updated.m;
run Azores_Indices_Updated.m;
load ENSO3_4.mat

% Step 2 - The STH array that is created below contains all the STH variables %
STH=[HHLAT_MA,HHLAT_AM,HHLAT_MJ,HHLAT_JJ,HHLAT_JA,HHLAT_AS,HHLAT_SO,HHLAT_MAM,...
    HHLAT_AMJ,HHLAT_MJJ,HHLAT_JJA,HHLAT_JAS,HHLAT_ASO,HHLAT_MAMJ,HHLAT_AMJJ,...
    HHLAT_MJJA,HHLAT_JJAS,HHLAT_JASO,HHLON_MA,HHLON_AM,HHLON_MJ,HHLON_JJ,HHLON_JA,HHLON_AS,HHLON_SO,HHLON_MAM,...
    HHLON_AMJ,HHLON_MJJ,HHLON_JJA,HHLON_JAS,HHLON_ASO,HHLON_MAMJ,HHLON_AMJJ,...
    HHLON_MJJA,HHLON_JJAS,HHLON_JASO,HHPRS_MA,HHPRS_AM,HHPRS_MJ,HHPRS_JJ,HHPRS_JA,HHPRS_AS,HHPRS_SO,HHPRS_MAM,...
    HHPRS_AMJ,HHPRS_MJJ,HHPRS_JJA,HHPRS_JAS,HHPRS_ASO,HHPRS_MAMJ,HHPRS_AMJJ,...
    HHPRS_MJJA,HHPRS_JJAS,HHPRS_JASO,SPLAT_MA,SPLAT_AM,SPLAT_MJ,SPLAT_JJ,SPLAT_JA,SPLAT_AS,SPLAT_SO,SPLAT_MAM,...
    SPLAT_AMJ,SPLAT_MJJ,SPLAT_JJA,SPLAT_JAS,SPLAT_ASO,SPLAT_MAMJ,SPLAT_AMJJ,...
    SPLAT_MJJA,SPLAT_JJAS,SPLAT_JASO,SPLON_MA,SPLON_AM,SPLON_MJ,SPLON_JJ,SPLON_JA,SPLON_AS,SPLON_SO,SPLON_MAM,...
    SPLON_AMJ,SPLON_MJJ,SPLON_JJA,SPLON_JAS,SPLON_ASO,SPLON_MAMJ,SPLON_AMJJ,...
    SPLON_MJJA,SPLON_JJAS,SPLON_JASO,SPPRS_MA,SPPRS_AM,SPPRS_MJ,SPPRS_JJ,SPPRS_JA,SPPRS_AS,SPPRS_SO,SPPRS_MAM,...
    SPPRS_AMJ,SPPRS_MJJ,SPPRS_JJA,SPPRS_JAS,SPPRS_ASO,SPPRS_MAMJ,SPPRS_AMJJ,...
    SPPRS_MJJA,SPPRS_JJAS,SPPRS_JASO,SALAT_MA,SALAT_AM,SALAT_MJ,SALAT_JJ,SALAT_JA,SALAT_AS,SALAT_SO,SALAT_MAM,...
    SALAT_AMJ,SALAT_MJJ,SALAT_JJA,SALAT_JAS,SALAT_ASO,SALAT_MAMJ,SALAT_AMJJ,...
    SALAT_MJJA,SALAT_JJAS,SALAT_JASO,SALON_MA,SALON_AM,SALON_MJ,SALON_JJ,SALON_JA,SALON_AS,SALON_SO,SALON_MAM,...
    SALON_AMJ,SALON_MJJ,SALON_JJA,SALON_JAS,SALON_ASO,SALON_MAMJ,SALON_AMJJ,...
    SALON_MJJA,SALON_JJAS,SALON_JASO,SAPRS_MA,SAPRS_AM,SAPRS_MJ,SAPRS_JJ,SAPRS_JA,SAPRS_AS,SAPRS_SO,SAPRS_MAM,...
    SAPRS_AMJ,SAPRS_MJJ,SAPRS_JJA,SAPRS_JAS,SAPRS_ASO,SAPRS_MAMJ,SAPRS_AMJJ,...
    SAPRS_MJJA,SAPRS_JJAS,SAPRS_JASO,AZLAT_MA,AZLAT_AM,AZLAT_MJ,AZLAT_JJ,AZLAT_JA,AZLAT_AS,AZLAT_SO,AZLAT_MAM,...
    AZLAT_AMJ,AZLAT_MJJ,AZLAT_JJA,AZLAT_JAS,AZLAT_ASO,AZLAT_MAMJ,AZLAT_AMJJ,...
    AZLAT_MJJA,AZLAT_JJAS,AZLAT_JASO,AZLON_MA,AZLON_AM,AZLON_MJ,AZLON_JJ,AZLON_JA,AZLON_AS,AZLON_SO,AZLON_MAM,...
    AZLON_AMJ,AZLON_MJJ,AZLON_JJA,AZLON_JAS,AZLON_ASO,AZLON_MAMJ,AZLON_AMJJ,...
    AZLON_MJJA,AZLON_JJAS,AZLON_JASO,AZPRS_MA,AZPRS_AM,AZPRS_MJ,AZPRS_JJ,AZPRS_JA,AZPRS_AS,AZPRS_SO,AZPRS_MAM,...
    AZPRS_AMJ,AZPRS_MJJ,AZPRS_JJA,AZPRS_JAS,AZPRS_ASO,AZPRS_MAMJ,AZPRS_AMJJ,...
    AZPRS_MJJA,AZPRS_JJAS,AZPRS_JASO];
...
for h=1:40 %The variable h is assigned to a number representing the hth-year being forecasted in the 40-year analysis.%
    ...
    for i=1:216 %Counter i iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
        ...
        if round(abs(C1(1,2)),2)>=0.42 %The correlation between Variable1 and ENSO must meet the threshold (to check the variable's predictive power of ENSO over the past 30 years), or the loop moves to the next variable.%
            for j=1:216 %Counter j iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
                ...
                if round(abs(C3(1,2)),2)>=0.42 && round(abs(C2(1,2)),2)<=0.42 %The correlation calculated in the previous two lines must pass the thresholds, or the loop moves to the next Variable2. In the example given in the paper, the correlation is calculated for [Variable2(1948-1977),ENSO(1949-1978)], as well as, [Variable1(1948-1977),Variable2(1948-1977)] when forecasting 1979.%
                    ...
                    run Regression_Projections_2_39Year.m %Now that all thresholds are met, the script creating forecasts is run for the variables that have just passed the tests above.%
                end
            end
        end
    end
...
run Output_Tables_39Year.m %This script outputs key statistics for the models.%
%run Mean_Stdv_Projections.m