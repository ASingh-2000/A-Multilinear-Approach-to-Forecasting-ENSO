...
% % % %----------------------------------------------------------------------------------------------------------------------------% % % %
STH=[HHLAT_MA,HHLAT_AM,HHLAT_MJ,HHLAT_JJ,HHLAT_JA,HHLAT_AS,HHLAT_MAM,...
    HHLAT_AMJ,HHLAT_MJJ,HHLAT_JJA,HHLAT_JAS,HHLAT_MAMJ,HHLAT_AMJJ,...
    HHLAT_MJJA,HHLAT_JJAS,HHLON_MA,HHLON_AM,HHLON_MJ,HHLON_JJ,HHLON_JA,HHLON_AS,...
    HHLON_MAM,HHLON_AMJ,HHLON_MJJ,HHLON_JJA,HHLON_JAS,HHLON_MAMJ,...
    HHLON_AMJJ,HHLON_MJJA,HHLON_JJAS,HHPRS_MA,HHPRS_AM,HHPRS_MJ,HHPRS_JJ,HHPRS_JA,...
    HHPRS_AS,HHPRS_MAM,HHPRS_AMJ,HHPRS_MJJ,HHPRS_JJA,HHPRS_JAS,...
    HHPRS_MAMJ,HHPRS_AMJJ,HHPRS_MJJA,HHPRS_JJAS, SPLAT_MA,SPLAT_AM,SPLAT_MJ,SPLAT_JJ,SPLAT_JA,SPLAT_AS,SPLAT_MAM,...
    SPLAT_AMJ,SPLAT_MJJ,SPLAT_JJA,SPLAT_JAS,SPLAT_MAMJ,SPLAT_AMJJ,...
    SPLAT_MJJA,SPLAT_JJAS,SPLON_MA,SPLON_AM,SPLON_MJ,SPLON_JJ,SPLON_JA,SPLON_AS,...
    SPLON_MAM,SPLON_AMJ,SPLON_MJJ,SPLON_JJA,SPLON_JAS,SPLON_MAMJ,...
    SPLON_AMJJ,SPLON_MJJA,SPLON_JJAS,SPPRS_MA,SPPRS_AM,SPPRS_MJ,SPPRS_JJ,SPPRS_JA,...
    SPPRS_AS,SPPRS_MAM,SPPRS_AMJ,SPPRS_MJJ,SPPRS_JJA,SPPRS_JAS,...
    SPPRS_MAMJ,SPPRS_AMJJ,SPPRS_MJJA,SPPRS_JJAS, SALAT_MA,SALAT_AM,SALAT_MJ,SALAT_JJ,SALAT_JA,SALAT_AS,SALAT_MAM,...
    SALAT_AMJ,SALAT_MJJ,SALAT_JJA,SALAT_JAS,SALAT_MAMJ,SALAT_AMJJ,...
    SALAT_MJJA,SALAT_JJAS,SALON_MA,SALON_AM,SALON_MJ,SALON_JJ,SALON_JA,SALON_AS,...
    SALON_MAM,SALON_AMJ,SALON_MJJ,SALON_JJA,SALON_JAS,SALON_MAMJ,...
    SALON_AMJJ,SALON_MJJA,SALON_JJAS,SAPRS_MA,SAPRS_AM,SAPRS_MJ,SAPRS_JJ,SAPRS_JA,...
    SAPRS_AS,SAPRS_MAM,SAPRS_AMJ,SAPRS_MJJ,SAPRS_JJA,SAPRS_JAS,...
    SAPRS_MAMJ,SAPRS_AMJJ,SAPRS_MJJA,SAPRS_JJAS, AZLAT_MA,AZLAT_AM,AZLAT_MJ,AZLAT_JJ,AZLAT_JA,AZLAT_AS,AZLAT_MAM,...
    AZLAT_AMJ,AZLAT_MJJ,AZLAT_JJA,AZLAT_JAS,AZLAT_MAMJ,AZLAT_AMJJ,...
    AZLAT_MJJA,AZLAT_JJAS,AZLON_MA,AZLON_AM,AZLON_MJ,AZLON_JJ,AZLON_JA,AZLON_AS,...
    AZLON_MAM,AZLON_AMJ,AZLON_MJJ,AZLON_JJA,AZLON_JAS,AZLON_MAMJ,...
    AZLON_AMJJ,AZLON_MJJA,AZLON_JJAS,AZPRS_MA,AZPRS_AM,AZPRS_MJ,AZPRS_JJ,AZPRS_JA,...
    AZPRS_AS,AZPRS_MAM,AZPRS_AMJ,AZPRS_MJJ,AZPRS_JJA,AZPRS_JAS,...
    AZPRS_MAMJ,AZPRS_AMJJ,AZPRS_MJJA,AZPRS_JJAS];
...
for h=1:40 %The variable h is assigned to a number representing the hth-year being forecasted in the 40-year analysis.%
    ...
    for i=1:180 %Counter i iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
        ...
        if round(abs(C1(1,2)),2)>=0.42 %The correlation between Variable1 and ENSO must meet the threshold (to check the variable's predictive power of ENSO over the past 30 years), or the loop moves to the next variable.%
            for j=1:180 %Counter j iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
