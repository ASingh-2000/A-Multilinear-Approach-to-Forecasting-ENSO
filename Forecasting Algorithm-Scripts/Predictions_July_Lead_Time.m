...
% % % %----------------------------------------------------------------------------------------------------------------------------% % % %
STH=[HHLAT_MA,HHLAT_AM,HHLAT_MJ,HHLAT_JJ,HHLAT_MAM,...
    HHLAT_AMJ,HHLAT_MJJ,HHLAT_MAMJ,HHLAT_AMJJ,...
    HHLON_MA,HHLON_AM,HHLON_MJ,HHLON_JJ,...
    HHLON_MAM,HHLON_AMJ,HHLON_MJJ,HHLON_MAMJ,...
    HHLON_AMJJ,HHPRS_MA,HHPRS_AM,HHPRS_MJ,HHPRS_JJ,...
    HHPRS_MAM,HHPRS_AMJ,HHPRS_MJJ,...
    HHPRS_MAMJ,HHPRS_AMJJ,SPLAT_MA,SPLAT_AM,SPLAT_MJ,SPLAT_JJ,SPLAT_MAM,...
    SPLAT_AMJ,SPLAT_MJJ,SPLAT_MAMJ,SPLAT_AMJJ,...
    SPLON_MA,SPLON_AM,SPLON_MJ,SPLON_JJ,...
    SPLON_MAM,SPLON_AMJ,SPLON_MJJ,SPLON_MAMJ,...
    SPLON_AMJJ,SPPRS_MA,SPPRS_AM,SPPRS_MJ,SPPRS_JJ,...
    SPPRS_MAM,SPPRS_AMJ,SPPRS_MJJ,...
    SPPRS_MAMJ,SPPRS_AMJJ,SALAT_MA,SALAT_AM,SALAT_MJ,SALAT_JJ,SALAT_MAM,...
    SALAT_AMJ,SALAT_MJJ,SALAT_MAMJ,SALAT_AMJJ,...
    SALON_MA,SALON_AM,SALON_MJ,SALON_JJ,...
    SALON_MAM,SALON_AMJ,SALON_MJJ,SALON_MAMJ,...
    SALON_AMJJ,SAPRS_MA,SAPRS_AM,SAPRS_MJ,SAPRS_JJ,...
    SAPRS_MAM,SAPRS_AMJ,SAPRS_MJJ,...
    SAPRS_MAMJ,SAPRS_AMJJ,AZLAT_MA,AZLAT_AM,AZLAT_MJ,AZLAT_JJ,AZLAT_MAM,...
    AZLAT_AMJ,AZLAT_MJJ,AZLAT_MAMJ,AZLAT_AMJJ,...
    AZLON_MA,AZLON_AM,AZLON_MJ,AZLON_JJ,...
    AZLON_MAM,AZLON_AMJ,AZLON_MJJ,AZLON_MAMJ,...
    AZLON_AMJJ,AZPRS_MA,AZPRS_AM,AZPRS_MJ,AZPRS_JJ,...
    AZPRS_MAM,AZPRS_AMJ,AZPRS_MJJ,...
    AZPRS_MAMJ,AZPRS_AMJJ];
...
for h=1:40 %The variable h is assigned to a number representing the hth-year being forecasted in the 40-year analysis.%
    ...
    for i=1:108 %Counter i iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
        ...
        if round(abs(C1(1,2)),2)>=0.42 %The correlation between Variable1 and ENSO must meet the threshold (to check the variable's predictive power of ENSO over the past 30 years), or the loop moves to the next variable.%
            for j=1:108 %Counter j iterates through the STH list and chooses the first variable being tested as a predictor in the set.%
